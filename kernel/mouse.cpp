...
MouseCursor::MouseCursor(PixelWriter* writer, PixelColor erase_color, Vector2D<int> initial_positoin) :pixel_writer_{writer}, erase_color_{erase_color}, position_{initial_positoin} {
